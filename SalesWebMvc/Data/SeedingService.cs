...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Guilherme Brito", "guilherme@gmail.com", new DateTime(2000, 3, 18), 3000.0, d1);
            Seller s2 = new Seller(2, "Julia Mendes", "julia@gmail.com", new DateTime(2000, 5, 16), 1520.0, d4);
            Seller s3 = new Seller(3, "João Gilberto", "joãog@gmail.com", new DateTime(2000, 6, 30), 2500.0, d1);
            Seller s4 = new Seller(4, "Lucas Martinez", "lucasmartinez@gmail.com", new DateTime(2000, 4, 09), 1000.0, d3);
            Seller s5 = new Seller(5, "Ana Maria", "anam@gmail.com", new DateTime(1972, 4, 18), 2650.0, d4);
            Seller s6 = new Seller(6, "Marcos Brito", "marcosbg@gmail.com", new DateTime(1989, 12, 21), 1550.0, d3);
